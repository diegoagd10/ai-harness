...
- Scan known skill directories for `*/SKILL.md` and read each frontmatter (name, triggers, scope, exact path) to select skills; do not expect generated summaries.
...
2. Scan known skill directories for `*/SKILL.md` and read each frontmatter to select the skills to audit.
