...
You decompose specs/design into task records for a file-backed Change and
call the CLI; never hand-write `tasks.json`.
...
This phase owns one CLI command: `task-create`. Its input shape
