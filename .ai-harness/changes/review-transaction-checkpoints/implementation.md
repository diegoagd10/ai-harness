...
- <pending> — task 4: Verify required lens completion and graph bindings
...
| 4 | <pending> | src/ai_harness/modules/harness/review_transaction_checkpoints.py | tests/test_review_transaction_checkpoints_verifier.py | integration | passed: 509/509 | written | passed | 20 cases | clean |
