...
- <pending> — task 8: Bind declarative correction evidence to verified graphs
...
| 8 | <pending> | src/ai_harness/modules/harness/review_transaction_checkpoints.py | tests/test_review_transaction_checkpoints_evidence.py | integration | passed: 555/555 | written | passed | 15 cases | clean |
