...
- <sha> — task 4: document-orchestrator-forwarding-of-version-2-context
...
| 4    | <sha>  | src/ai_harness/resources/change-agent/change-orchestrator.md, expected/change-orchestrator.md, .ai-harness/specs/agent-cli-contracts/orchestrator-cli-contract.md | tests/test_renderers.py | unit | passed: 683/683 | written | passed | 3 cases | clean |
